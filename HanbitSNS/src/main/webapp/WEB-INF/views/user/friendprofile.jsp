...
$("document").ready(function(){
	...
	$(".btn1").click(function(){
		...
		var url ="http://192.168.10.47:8000/mysns/user/logout.do";
	...
	$("#search").click(function(){
		...
		$("#searchimg").click(function(){
			if($("#search").val()==null){
				...
				if($("p:contains("+k+")")){
				$("p:contains("+k+")").attr("tabindex", -1).focus();
				}
				else{
	...
	$("#fb1").click(function(){
		alert("액션!");
		var url = "http://192.168.10.47:8000/mysns/friend";
		$(location).attr('href',url);
	...
	$(".btn2").click(function(){
		...
		alert($(".btn2").text());
		var url ="http://192.168.10.47:8000/mysns/user/dropout";
		$(location).attr('href',url);
			...
			<!-- 폼 -->
				<form action="Update.do" id="UpdateSNS" method="POST">
					...
					<div id="profileForm3">
						...
						<div id="myprofile">
							${list.phone} (${list.gender}) 
						<span class="btn_Modal">●●●</span>
...
${list.name} ${list.age }세
						...
						<div id="nickname">
							<span class="badge"><h5 style="font-weight:bold;font-size:9pt;">ㆍ닉네임ㆍ </h5></span>  &nbsp;&nbsp; &nbsp;&nbsp;${list.nick}
						</div>
						<div id="myAddress">
							<span class="badge"><h5 style="font-weight:bold;font-size:9pt;">ㆍ거주지ㆍ </h5></span>  &nbsp;&nbsp; &nbsp;&nbsp;${list.address}
						</div>
					...
					<!-- 	{% endblock %} -->
						<div id="followerform">
							...
							<button type="button" id="contentlist" class="btn btn-primary">
								게시물<span class="badge" style="font-size:12pt;font-weight:bold;">${list.contentnumber}개</span>
							</button>
							
						</div>
						<div id ="matpal" >
							<div id="matpal-top">맞팔수 <span class="badge">${list.fcount3} 명</span></div><br/>
							<h5> <input id="search" style="margin-left:25px;border-radius:15px;"type="text">
								<img id ="searchimg" style ="width:30px;,heigth:30px;" src='../resources/IMAGE/search.PNG'></h5>
							   
							<div id="auto">
							<c:forEach items="${list0}" var="list0" > 
							&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href='friendprofile.do?phone=${list0.phone}'> <img style="width:45px;height:45px;cursor:pointer;" src='../resources/UPLOADIMG/${list0.image}'> </a>  &nbsp;&nbsp; &nbsp;&nbsp;     <a href='friendprofile.do?phone=${list0.phone}'>  ${list0.phone} </a><p id="sn">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp; ${list0.name} </p> </br> 
...
<div id="kk">  
	<span style="font-size: 13pt;"> ${list.name}님이 올린 게시물</span><br />
		...
		<div class="outline">
				...
				<c:forEach items="${image}" var="image">
					...
					<div style="margin-left:650px; margin-top:-300px;">
						...
						<div style="font-size:10pt;float:left; margin-bottom:25px; margin-right:150px;background-color:RGB(242, 240, 238);width:365px;height:300px; border:2px solid RGB(242, 240, 238);border-radius:15px;">
						업로드 날짜: ${image.uploaddate}<br/>
						<br/>
						
						내용: 
						<br/>
						<div style="font-size:14pt;border: 2px solid RGB(242, 240, 238);margin-left:40px;background-color:white; border-radius:15px;width:280px; height: 200px;">${image.content}
						</div>
	...
	<!-------------------------------- outline end ---------------------------- -->
						...
						<div class="modal" id="testModal2" tabindex="-1" role="dialog">
							<div class="modal-dialog modal-sm">
								<div class="modal-content">
									
									<c:forEach items="${list2}" var="list2" > 	
									<img style="width:35px;height:35px;" src='../resources/UPLOADIMG/${list2.image}'> ${list2.phone} ${list2.name}  </br>
								
									</c:forEach>
									<button type="button" id="fb1" class="btn btn-info">친구 페이지로</button>
									
								</div>
							</div>
						</div>
						<div class="modal" id="testModal3" tabindex="-1" role="dialog">
							<div class="modal-dialog modal-sm">
								<div class="modal-content">
									
									<c:forEach items="${list3}" var="list3" > 
									<img style="width:35px;height:35px;" src='../resources/UPLOADIMG/${list3.image}'> ${list3.phone} ${list3.name} </br> 
									
									</c:forEach>
									<button type="button" id="fb2" class="btn btn-danger">친구추가 페이지로</button>
